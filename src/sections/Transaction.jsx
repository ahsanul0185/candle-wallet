...
const Transaction = () => {
    ...
    <div className="relative bg-primary z-0 overflow-x-clip">
          ...
          <img className="absolute w-24 right-0 md:right-20 top-56 rotate-45 [mask-image:linear-gradient(to_top,_black,_transparent)]" src={ pentagon} alt="" />
          <img className="absolute hidden lg:block w-52 right-56 top-[350px]" src={ zigzag1} alt="" />
          <img className="absolute w-52 -left-20 top-72 rotate-12 -z-10 [mask-image:linear-gradient(to_top,_black,_transparent)]" src={ pentagon} alt="" />
          <img className="absolute w-44 md:w-52 right-0 top-[850px] -z-10" src={ shapeBridge} alt="" />
          <img className="absolute w-40 md:w-52 -z-10 left-0 top-[1350px]" src={ zigzag2} alt="" />
          <img className="absolute w-56 md:w-96 -right-20 bottom-12 rotate-12 -z-10 [mask-image:linear-gradient(to_top,_black,_transparent)]" src={ pentagon} alt="" />
