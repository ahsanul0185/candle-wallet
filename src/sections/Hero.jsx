...
const Hero = () => {
  return (
      ...
      <div className="section-width text-center">
        ...
        <button className="px-12 md:px-28 py-2 md:py-5 bg-secondary rounded-md text-2xl font-bold text-white cursor-pointer">
          Let's Get Started
        </button>
        ...
        <div className="flex flex-col items-center pt-10 pb-36 md:pb-20 justify-center">
          ...
          <button className="flex items-center justify-center gap-5 bg-primaryDeep rounded-md text-white text-lg md:text-2xl font-bold px-4 md:px-8 py-3">
            Candle Mainnet is open for developers
            <img className="size-10" src={angleRight} alt="" />
          </button>
        </div>
      </div>
