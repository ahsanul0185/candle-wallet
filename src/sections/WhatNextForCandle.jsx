  ...
  return (
      <div className='bg-light pb-10'>
          <div className='section-width flex flex-col items-center py-10'>
              ...
              <p className='text-3xl md:text-4xl mt-6 lg:w-3/5 lg:text-center'>We're currently working on a number of features that will be added to the platform in the coming months.</p>
          </div>
    </div>
  )
}
